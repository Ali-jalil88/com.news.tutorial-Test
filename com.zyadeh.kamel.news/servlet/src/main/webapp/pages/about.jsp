...
<head>
    <meta charset="UTF-8">
    <title>about</title>
    <link rel="stylesheet" href="../statics/about.css">
</head>
<body>
...
<section class="container">
    ...
    <img class="img" src="<c:url value="/pages/test/buy-now-bg.jpg"/>">
    <div class="texts">
        <p class="first_paragraph">
            ...
            effectively stamping his ticket to Congress next year. Dr. Jackson victory in the 13th Congressional District over
        </p>
